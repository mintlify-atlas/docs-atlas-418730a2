...
<Steps>
  <Step title="Quick Start">
    Follow the [Quick Start Guide](/get-started/quickstart) to get up and running in under 2 minutes.
  </Step>
  
  <Step title="Installation">
    Review the [Installation Guide](/get-started/installation) for detailed installation options.
  </Step>
  ...
  <Step title="Explore Features">
    Dive into specific features like [Continuous Learning](/features/continuous-learning) and [Token Optimization](/features/token-optimization).
  </Step>
</Steps>
