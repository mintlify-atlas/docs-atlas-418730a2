...
<CardGroup cols={2}>
  <Card title="Migration Guide" icon="book" href="#">
    `.opencode/MIGRATION.md` — Migrate from Claude Code
  </Card>
  <Card title="Plugin README" icon="plug" href="#">
    `.opencode/README.md` — OpenCode plugin details
  </Card>
  <Card title="Consolidated Rules" icon="list" href="#">
    `.opencode/instructions/INSTRUCTIONS.md` — All rules in one file
  </Card>
  <Card title="LLM Documentation" icon="robot" href="#">
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Tools" icon="wrench" href="#">
    Learn to define custom tools
  </Card>
  <Card title="Hook Events" icon="bolt" href="#">
