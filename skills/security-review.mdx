...
description: 'Comprehensive security checklist for authentication, input validation, and vulnerability prevention'
---
...
<Accordion title="Never Concatenate SQL">
...
<Accordion title="Row Level Security (Supabase)">
